...
//     template <>                                                                                                      \
//     template <>                                                                                                      \
//     GPU_HOST void Coordinator<GpushmemBackend, MODE>::Gather<TYPE>(const TYPE* sendbuf, TYPE* recvbuf, size_t count, \
...
//                 recvbuf + comm->GlobalRank() * count, sendbuf, count,                                                \
...
//     template <>                                                                                                      \
//     template <>                                                                                                      \
//     GPU_HOST void Coordinator<GpushmemBackend, MODE>::Gather<TYPE>(TYPE * buffer, size_t count, int root,            \
...
//     template <>                                                                                                        \
//     template <>                                                                                                        \
//     GPU_DEVICE void Coordinator<GpushmemBackend, MODE>::Gather<SCOPE, TYPE>(                                           \
...
//                 nvshmem_##TYPENAME##_put_nbi(recvbuf + comm->GlobalRank() * count, sendbuf, count,                     \
//                                              nvshmem_team_translate_pe(comm->nvshmem_comm, root, NVSHMEM_TEAM_WORLD)); \
//             }                                                                                                          \
//             comm->Barrier<SCOPE>();                                                                                    \
//         }                                                                                                              \
...
//     template <>                                                                                                        \
//     template <>                                                                                                        \
//     GPU_DEVICE void Coordinator<GpushmemBackend, MODE>::Gather<SCOPE, TYPE>(TYPE * buffer, size_t count, int root,     \
//                                                                             Communicator<GpushmemBackend>* comm) {     \
