#ifndef __UNICONN_INCLUDE_UNICONN_GPUMPI_ENVIRONMENT_HPP_
#define __UNICONN_INCLUDE_UNICONN_GPUMPI_ENVIRONMENT_HPP_

#include "common.hpp"
#include "uniconn/interfaces/environment.hpp"
namespace uniconn {
template <>
class Environment<MPIBackend> {
   private:
...
#endif  // __UNICONN_INCLUDE_UNICONN_GPUMPI_ENVIRONMENT_HPP_